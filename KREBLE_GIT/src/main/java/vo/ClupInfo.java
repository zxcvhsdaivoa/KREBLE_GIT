...
public class ClupInfo {
	...
	public void setClup_no(int clup_no) {
		this.clup_no = clup_no;
	}
	...
	public void setClup_rank(String clup_rank) {
		this.clup_rank = clup_rank;
	}
	public String getClup_howjoin() {
		return clup_howjoin;
	}
	public void setClup_howjoin(String clup_howjoin) {
		this.clup_howjoin = clup_howjoin;
	}
	public String getClup_pw() {
		return clup_pw;
	}
	...
	public void setClup_logo(String clup_logo) {
		this.clup_logo = clup_logo;
	}
	public String getClup_disclose() {
		return clup_disclose;
	}
	public void setClup_disclose(String clup_disclose) {
		this.clup_disclose = clup_disclose;
	}
	public String getClup_text() {
		return clup_text;
	}
