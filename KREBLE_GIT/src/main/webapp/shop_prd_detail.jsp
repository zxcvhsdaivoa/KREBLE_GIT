	...
	%>
		...
		<article id="pd_detail_no0">
			...
			<%
				switch(p_no){
				case 's':
					%><div class="sue_label"><%=aa.getPrd_name()%></div>
					<%
					break;
				case 'u':
					%><div class="uni_label"><%=aa.getPrd_name()%></div>
					<%
					break;
				case 'b':
					%><div class="ball_label"><%=aa.getPrd_name()%></div>
					<%
					break;
				case 'e':
					%><div class="etc_label"><%=aa.getPrd_name()%></div>
					<%
					break;
				}
			%>
